...
export declare const PROXY_MANAGED_SENTINEL = "proxy-managed";
 ...
 */
export declare function getApiKey(modelRegistry: AuthModelRegistry, providerNames: string[]): Promise<string | undefined>;
/**
 ...
 */
export declare function buildAuthHeaders(modelRegistry: AuthModelRegistry, providerNames: string | string[], extra?: Record<string, string>): Promise<Record<string, string>>;
export {};
