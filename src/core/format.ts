...
export function usedFromLeft(leftPercent: number | undefined): number | undefined {
 ...
 */
export function formatDurationFromNow(epochSeconds: number | undefined): string | undefined {
